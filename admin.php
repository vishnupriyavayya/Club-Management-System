      ...
      <div class="row">
        ...
        <div class="col-md-3">
           <div class="service-box" style="background-image:url(img/img3.png); background-size: cover;height: 300px;">
            ...
            <div class="service-content ">
              <h2 class="s-title text-white"> <b>SMART-TECH</b></h2>
        ...
        <div class="col-md-3">
           <div class="service-box" style="background-image:url(img/newst.jpg); background-size: cover;height: 300px;">
            ...
            <div class="service-content ">
              <h2 class="s-title text-white"> <b>NSS CLUB</b></h2>
        ...
        <div class="col-md-3">
          <div class="service-box" style="background-image:url(img/sportsto.jpg); background-size: cover;height: 300px;">
            ...
            <div class="service-content ">
              <h2 class="s-title text-white"> <b>SPORTS CLUB</b></h2>
...
<div class="testimonials paralax-mf bg-image" style="background-image: url(img/lastimg.png)">
      <div class="overlay-mf"></div>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/srmlogo.jpg" alt="" class="rounded-circle b-shadow-a" width="150" height="150">
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico text-white">
                      ...
                      <li><span class="ion-email"></span> srmuniversity@gmail.com</li>
                    </ul>
                  </div>
